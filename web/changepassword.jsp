                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row g-3 needs-validation" action="otppassword.action" method="post" novalidate>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="password" name="newotp" class="form-control" id="yourNewPassword" required>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <button class="btn btn-primary w-100" type="submit">Confirm and submit</button>
                                            </div>
                                            <div class="col-12">
