...
<!--                                <div class="g-signin2" data-onsuccess="onSignIn"></div>
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row g-3 needs-validation" action="registeruser.action" method="post" novalidate />
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="date" name="dob" class="form-control" id="youdob" required>
                                            <div class="invalid-feedback">You are under age</div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="address" class="form-control" id="youaddress" required>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="acceptTerms">I agree and accept the <a href="termsAndCondition.jsp">terms and conditions</a></label>
